...
```{r, echo = TRUE}
# How are these objects distrubted in time?
clean_data_obj %>% 
...
- You can't document everything! If some tricky field is just not relevant to your research, then drop it.
...
- You **will** forget what you did in a few monts. Or even a few days. Docs will remind you.
